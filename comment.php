...
function wp_get_current_commenter() {
	...
	//if ( isset($_COOKIE['comment_author_phone_'.COOKIEHASH]) )
		//$comment_author_phone = $_COOKIE['comment_author_phone_'.COOKIEHASH];
...
/**
 * Inserts a comment to the database based on Nexmo phone verification
 *
...
function wp_insert_comment( $commentdata ) {
	...
	$comment_author_phone = ! isset( $data['comment_author_phone'] ) ? '' : $data['comment_author_phone'];
	...
	$compacted = compact( 'comment_post_ID', 'comment_author','comment_author_phone', 'comment_author_email', 'comment_author_url', 'comment_author_IP', 'comment_date', 'comment_date_gmt', 'comment_content', 'comment_karma', 'comment_approved', 'comment_agent', 'comment_type', 'comment_parent', 'user_id' );
...
function wp_filter_comment($commentdata) {
	...
	//$commentdata['comment_author_phone'] = apply_filters( 'pre_comment_author_phone', $commentdata['comment_author_phone'] );
